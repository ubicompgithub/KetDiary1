...
public class NoteCategory2 {
	...
	private void noteSetting(){
		...
		dictionary.put(503, "喝酒且想用K");
		dictionary.put(504, "想到用K後的舒服感");
		dictionary.put(505, "沒來由地想用K");
		...
		dictionary.put(607, "沒達到他人期望");
		dictionary.put(608, "感覺需要勇氣才能面對他人");
		dictionary.put(609, "覺得被他人掌控");
